...
class Contact:
    def __init__(self, firstname=None, middlename=None, nickname=None, title=None, lastname=None, company=None,
                 ...
                 address2=None, phone2=None, notes=None, id=None, all_emails_from_home_page=None,
    ...
    def __repr__(self):
        return "%s:%s_%s" % (self.id, self.lastname, self.firstname)
